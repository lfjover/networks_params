% example of 3 infection networks
clear all;
...
%% perturbation-based framework one plot for each trend, single set
clear all;
...
%% plot and fit bio vs nest for all deltas for  perfectly nested net (fm100)
...
%% plot and fit bio vs nest for all deltas for low-nestedness (fm1)
...
%% ruled-base framework only fm100

runC = {'rb_fm100_v2','rb_fm1_v2'};

figure(1);clf;setfigure(10,6,5,5)
fs = 18;
ms = 6;
run= 1;
...
clear all
figure(1);clf;setfigure(20,15,5,5)
fs = 14;
ms = 6;
